...
const ContactPage = () => ( 
  ...
  <Layout pageTitle="Contact Me">
      ...
      <div className="flex flex-col items-center w-full mx-auto">        
        <p className="lg:w-3/4 xl:w-1/2">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Dolores, consequuntur asperiores explicabo quis ut magnam, perferendis expedita odio impedit iure natus consectetur officia accusamus nisi alias quasi blanditiis! Sunt, provident!
