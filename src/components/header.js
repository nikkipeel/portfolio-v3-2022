...
<header className="dark:bg-bgDark dark:text-white bg-white text-dark flex flex-col xl:flex-row py-16">
  ...
  <div className="flex flex-col justify-center xl:items-end xl:w-1/2 text-center xl:text-right mt-12 mx-auto xl:mt-0 xl:mr-48 p-4 xl:p-0">
    ...
    <div className="flex justify-center items-center xl:justify-end mx-auto xl:mx-0 mt-8 p-8 xl:p-0">
      <button id="view-works" className="font-mono dark:bg-darkSecondary bg-secondary text-white font-semibold rounded shadow-md p-2 mr-8 transition duration-500 focus:ring-2 focus:ring-highlight tracking-tight">View Portfolio</button>
